        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 md:p-8 border border-orange-500/20 w-full max-w-md">
          ...
          {authMode === 'signin' ? (
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={signin}
                className="w-full bg-orange-500 hover:bg-orange-600 py-3 rounded-lg font-semibold transition-colors text-base"
              >
                Sign In
              </button>
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={register}
                className="w-full bg-green-500 hover:bg-green-600 py-3 rounded-lg font-semibold transition-colors text-base"
              >
                Create Account
              </button>
